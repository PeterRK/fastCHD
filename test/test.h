...
public:
	...
	bool write(const void*, size_t) noexcept override;
};

bool FakeWriter::operator!() const noexcept {
	return false;
}
bool FakeWriter::flush() noexcept {
	return true;
}
bool FakeWriter::write(const void *, size_t) noexcept {
	return true;
}